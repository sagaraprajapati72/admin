...
export default function CreateAuthorClient({ user }: Props) {
  const {
    handleSubmit,
    register,
    control,
  ...
  const onSubmit = async (data: AuthorFormData) => {
    ...
    try {
      const response = await fetch("/api/admin/authors", { method: "POST", body: formData });
            ...
            <VStack spacing={4} align="stretch">
              ...
              <FormControl isInvalid={!!errors.biography}>
                ...
                <Controller
                  ...
                  render={({ field }) => <ReactQuill theme="snow" value={field.value || ""} onChange={field.onChange} placeholder="Enter biography..." />}
                />
